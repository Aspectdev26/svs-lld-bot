...
import { ensureResetInstructionsPanel } from "./discord/resetInstructionsPanel.js";
...
async function main() {
  ...
  client.once("clientReady", () => {
    ...
    ensureResetInstructionsPanel(client).catch((err) => console.error("Failed to post reset instructions panel:", err));
